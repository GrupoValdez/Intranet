          ...
          @if( $idValidaView == false)
            @if($activi->descripcion_actividad == 'tienen una nueva')
              <div class="item PublicatiOn">
                ...
                <div class="content">
                  <a data-href='preview-conte/data/viewDme/{{ $activi->id_usuario}}/{{ $activi->id_post}}' href="#!" class="header datanotifiNew"><strong class="nameUserNotifique ">{{ $activi->nonbre_user}} </strong> {{ $activi->descripcion_actividad }} <span class="typeAccionNotifi">
            ...
            @elseif($activi->descripcion_actividad == 'Ha publicado nuevas')
               <div class="item NewFotos">
                  ...
                  <div class="content">
                    <a data-href='preview-conte/data/viewDme/{{ $activi->id_usuario}}/{{ $activi->id_post}}' href="#!" class="header datanotifiNew"><strong class="nameUserNotifique ">{{ $activi->nonbre_user}} </strong>  {{ $activi->descripcion_actividad }} <span class="typeAccionNotifi">fotos</span>
                    <input type="hidden" class="notifiview" name='datanotifi' value="{{  $activi->id }}">
                    <input type="hidden" class="notifiviewUser" name='datanotifi_iduser' value="{{  Auth::user()->id }}">
                    </a>
                  </div>
            ...
            @elseif($activi->descripcion_actividad == 'Ha publicado un nuevo')
                <div class="item NewFotos">
                   ...
                   <div class="content">
                     <a data-href='preview-conte/data/viewDme/{{ $activi->id_usuario}}/{{ $activi->id_post}}' href="#!" class="header datanotifiNew"><strong class="nameUserNotifique ">{{ $activi->nonbre_user}} </strong>  {{ $activi->descripcion_actividad }} <span class="typeAccionNotifi">documento</span>
                     <input type="hidden" class="notifiview" name='datanotifi' value="{{  $activi->id }}">
                     <input type="hidden" class="notifiviewUser" name='datanotifi_iduser' value="{{  Auth::user()->id }}">
                     </a>
                   </div>
          ...
          @if( $idValidaView == false)
            @if($activi->descripcion_actividad == 'Tiene una publicación')
              <div class="item NewFotos">
                 ...
                 <div class="content">
                   <a data-href='preview-conte/data/viewDme/{{ $activi->id_usuario}}/{{ $activi->id_post}}' href="#!" class="header datanotifiNew"><strong class="nameUserNotifique ">{{ $activi->nonbre_user}} </strong>  {{ $activi->descripcion_actividad }} <span class="typeAccionNotifi">urgente</span>
                   <input type="hidden" class="notifiview" name='datanotifi' value="{{  $activi->id }}">
                   <input type="hidden" class="notifiviewUser" name='datanotifi_iduser' value="{{  Auth::user()->id }}">
                   </a>
                 </div>
          ...
          @if( $idValidaView == false)
            @if($activi->descripcion_actividad == 'Agrego un nuevo evento')
              <div class="item NewFotos">
                 ...
                 <div class="content">
                   <a data-href='calendario' href="#!" class="header datanotifiNew"><strong class="nameUserNotifique ">{{ $activi->nonbre_user}} </strong>  {{ $activi->descripcion_actividad }} <span class="typeAccionNotifi">al calendario</span>
                   <input type="hidden" class="notifiview" name='datanotifi' value="{{  $activi->id }}">
                   <input type="hidden" class="notifiviewUser" name='datanotifi_iduser' value="{{  Auth::user()->id }}">
                   </a>
                 </div>
          ...
          @if( $idValidaView == false)
            @if($activi->descripcion_actividad == 'actualizó su perfil')
              <div class="item NewFotos">
                 ...
                 <div class="content">
                   <a data-href="profile-users/{{ $activi->id_usuario}}" href="#!" class="header datanotifiNew"><strong class='nameUserNotifique ' >{{ $activi->nonbre_user}} </strong>  {{ $activi->descripcion_actividad }} 
                   <input type="hidden" class="notifiview" name='datanotifi' value="{{  $activi->id }}">
                   <input type="hidden" class="notifiviewUser" name='datanotifi_iduser' value="{{  Auth::user()->id }}">
                   </a>
                 </div>
          ...
          @if( $idValidaView == false)
            @if($activi->descripcion_actividad == 'Hoy es el cumpleaños de')
              <div class="item NewFotos">
                 ...
                 <div class="content">
                   <a  data-href='preview-conte/data/viewDme/{{ $activi->id_usuario}}/{{ $activi->id_post}}' href="#!" class="header datanotifiNew"> {{ $activi->descripcion_actividad }} <strong class="nameUserNotifique ">{{ $activi->nonbre_user}} </strong>
                   <input type="hidden" class="notifiview" name='datanotifi' value="{{  $activi->id }}">
                   <input type="hidden" class="notifiviewUser" name='datanotifi_iduser' value="{{  Auth::user()->id }}">
                   </a>
                 </div>
          ...
          @if( $idValidaView == false)
            @if($activi->id_usuario == Auth::user()->id)
              <div class="item NewFotos">
                 ...
                 <div class="content">
                   <a  data-href='preview-conte/data/viewDme/{{ $activi->id_usuario}}/{{ $activi->id_post}}' href="#!" class="header datanotifiNew">{{ $activi->descripcion_actividad }} <span class="typeAccionNotifi ">les gusta tu publicación</span> 
                   <input type="hidden" class="notifiview" name='datanotifi' value="{{  $activi->id }}">
                   <input type="hidden" class="notifiviewUser" name='datanotifi_iduser' value="{{  Auth::user()->id }}">
                   </a>
                 </div>
          ...
          @if( $idValidaView == false)
            @if($activi->id_usuario == Auth::user()->id)
              <div class="item NewFotos">
                 ...
                 <div class="content">
                   <a  data-href='preview-conte/data/viewDme/{{ $activi->id_usuario}}/{{ $activi->id_post}}' href="#!" class="header datanotifiNew"> <span class="typeAccionNotifi">{{ $activi->nonbre_user}}</span> {{ $activi->descripcion_actividad }} 
                   <input type="hidden" class="notifiview" name='datanotifi' value="{{  $activi->id }}">
                   <input type="hidden" class="notifiviewUser" name='datanotifi_iduser' value="{{  Auth::user()->id }}">
                   </a>
                 </div>
